...
public class Principal {
    ...
    dominio.ej2.media(lista,lista.length-1);
    dominio.ej2.cuadrados(lista,lista.length-1);
    ...
    dominio.ej2.fib13(13);
    dominio.ej2.fib12(12);
    System.out.println("La relación entre los resultados de la división de fibonacci de 13 y 12 y la razón aurea es: "+dominio.ej2.equals((1+Math.sqrt(5))/2));
